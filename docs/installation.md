...
[PyPI](https://pypi.org/project/mqt.qudits/) and can be installed on all
...
To use the MQT Qudits Python package in your project,
...
- install MQT Qudits on your system
...
because it lets you detect installed versions of MQT Qudits
