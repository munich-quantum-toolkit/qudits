...
Then proceed to read the {doc}`tutorial>`.
If you are interested in the theory behind MQT Qudits, have a look at the publications in the {doc}`publication list <references>`.
...
If you are having trouble with the installation or the usage of MQT Qudits, please let us know on our {doc}`support page <support>`.
...
<a href="https://github.com/munich-quantum-toolkit/qudits/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=munich-quantum-toolkit/qudits" />
</a>
</p>
