...
- Install package without build isolation (fast rebuilds): `uv sync --inexact --no-dev --no-build-isolation-package mqt-qudits`
...
- NEVER edit `.pyi` files in `python/mqt/qudits/` manually; they are auto-generated by nanobind stubgen.
